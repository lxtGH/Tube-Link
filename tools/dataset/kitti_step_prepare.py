...
data_root = os.path.expanduser('/mnt/lustre/lixiangtai.vendor/data/KITTI-STEP/training/')
data_root_test = os.path.expanduser('/mnt/lustre/lixiangtai.vendor/data/KITTI-STEP/testing/')
data_out = os.path.expanduser('/mnt/lustre/lixiangtai.vendor/data/KITTI-STEP/kitti_out')
