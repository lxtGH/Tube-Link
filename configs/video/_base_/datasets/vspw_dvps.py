...
train_pipeline = [
    ...
    dict(type='LoadMultiAnnotationsDirect', mode='direct_pil'),
    dict(type='SeqResizeWithDepth', img_scale=(480, 100000), ratio_range=[1., 2.], keep_ratio=True),
