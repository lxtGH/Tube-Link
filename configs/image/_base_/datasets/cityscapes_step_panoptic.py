# dataset settings
dataset_type = 'CityscapesSTEPPanopticDataset'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'annotations/cityscapes_step_panoptic_train.json',
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/cityscapes_step_panoptic_val.json',
