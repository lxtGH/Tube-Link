...
class SeqRandomCropWithDepth(object):
    ...
    def __init__(self,
        ...
        self.bbox2label = {
            'gt_bboxes': ['gt_labels', 'gt_instance_ids', 'gt_clips_vis_emb'],
            'gt_bboxes_ignore': ['gt_labels_ignore', 'gt_instance_ids_ignore', 'gt_clips_vis_emb_ignore']
        }
        self.bbox2mask = {
            'gt_bboxes': 'gt_masks',
