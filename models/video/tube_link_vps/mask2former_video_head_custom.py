...
class Mask2FormerVideoHeadCustom(MaskFormerVideoHead):
    ...
    def forward_train(self,
        ...
        # forward
        all_cls_scores, all_mask_preds, query_preds = self.forward(feats, img_metas)
        ...
        if ref_mode:
            return None, all_cls_scores, all_mask_preds, query_preds, thing_gt_labels, thing_gt_masks
        else:
            return losses, all_cls_scores, all_mask_preds, query_preds, thing_gt_labels, thing_gt_masks
